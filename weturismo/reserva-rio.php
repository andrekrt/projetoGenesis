        ...
        if(isset($_POST['nome']) && !empty($_POST['nome'])){
          if(isset($_POST['dataNasc']) && !empty($_POST['dataNasc'])){
            if(isset($_POST['telefone']) && !empty($_POST['telefone'])){
              ...
              echo "<script> window.location = 'https://pagamento.gerencianet.com.br/botao-de-pagamento/c200247d-5c0f-4591-9502-8a963ef9ae83'; </script>";
...
<body>
    ...
    <section class="container-base">
        <div class="banner-viagem">
            <img src="imagens/slides/rio-de-janeior.png" alt="">

        </div>
        <div class="area-formulario-reserva">
            <form action="reserva-rio.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="exampleInputPassword1" name="dataNasc" required> 
                </div>
                <div class="form-group">
                  <label for="exampleFormControlInput1">Telefone:</label>
                  <input type="text" class="form-control mascaraTel" id="exampleFormControlInput1"  required name="telefone">
                </div>
                <div class="form-group">
                    <label for="inputState">Pacote:</label>
                    <select id="inputState" class="form-control">
                        <option selected value="900">Individual - R$ 1399,00</option>
                    </select>
                </div>
